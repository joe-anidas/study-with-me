				...
				<li class="dropdown ms-2">
					<a class="rounded-circle" href="#!" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<div class="avatar avatar-md avatar-indicators avatar-online">
							<img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-11.jpg" class="rounded-circle" />
						</div>
					</a>
            ...
            <div class="row ">
                <div class="col-xl-8 col-12 mb-5">
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-1.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-11.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-2.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-3.jpg"
                                                        class="rounded-circle">
                                                </span>
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-2.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-4.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-5.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-6.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-3.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-7.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-8.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-9.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-6.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-10.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-11.jpg"
                                                ...
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-12.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-4.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-13.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-14.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="<?php echo base_url(); ?>assets/images/avatar/avatar-15.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                    ...
                    align-items-center">
                                                <div>
                                                    <div >
                                                        <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-5.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1"> <a href="#!" class="text-inherit">Github
                                    ...
                                    <tbody>
                                        <tr >
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="#!"><img src="<?php echo base_url(); ?>assets/images/avatar/avatar-2.jpg" alt="Image"
                                        ...
                                        <tr >
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="#!">   <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-11.jpg" alt="Image"
                                                            class="avatar-md avatar rounded-circle"></a>
                                                    </div>
                                                    <div class="ms-3 lh-1">
                                        ...
                                        <tr >
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="#!"><img src="<?php echo base_url(); ?>assets/images/avatar/avatar-3.jpg" alt="Image"
                                                            class="avatar-md avatar rounded-circle"></a>
                                                    </div>
                                                    <div class="ms-3 lh-1">
                                        ...
                                        <tr >
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#!">  <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-4.jpg" alt="Image"
                                                            class="avatar-md avatar rounded-circle"></a>
                                                    </div>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="#!"> <img src="<?php echo base_url(); ?>assets/images/avatar/avatar-5.jpg" alt="Image"
                                                            class="avatar-md avatar rounded-circle"></a>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <a href="#!"><img src="<?php echo base_url(); ?>assets/images/avatar/avatar-6.jpg" alt="Image"
                                                            class="avatar-md avatar rounded-circle"></a>
                                                    </div>
                                                    <div class="ms-3 lh-1">
...
<!-- Mirrored from dashui.codescandy.com/dashuipro/horizontal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2025 03:29:24 GMT -->
</html>