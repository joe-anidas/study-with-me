...
<!-- Mirrored from dashui.codescandy.com/dashuipro/horizontal/dashboard-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2025 03:29:26 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8" />
...
<script src="<?php echo base_url(); ?>assets/js/vendors/color-modes.js"></script>
  ...
  <title>Ecommerce | Dash UI - Bootstrap 5 Admin Dashboard Template</title>
</head>
      ...
      <div class="app-content-area">
        <div class="container-fluid">
              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <table class="table table-sm table-borderless  mb-0 mt-5">
                    <tbody>
                      <tr>
                        <td><i class="mdi mdi-square-rounded text-primary fs-5 me-2"></i>Direct
                        </td>
                        <td class="text-end">$1200.42</td>

                      </tr>
                      <tr>
                        <td><i class="mdi mdi-square-rounded text-warning fs-5 me-2"></i>Affiliate
                        </td>
                        <td class="text-end">$353.42</td>

                      </tr>
                      <tr>
                        <td><i class="mdi mdi-square-rounded text-danger fs-5 me-2"></i>Sponsored
                        </td>
                        <td class="text-end">$413.31</td>

                      </tr>
                      <tr>
                        <td><i class="mdi mdi-square-rounded text-info fs-5 me-2"></i>E-mail
                        </td>
                        <td class="text-end">$235.72</td>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-6 mb-5">
              <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center ">
                ...
                <div class="card-body">
                  <div class="table-responsive table-card">
                    <table class="table text-nowrap mb-0 table-centered">
                      ...
                      <tbody>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-1.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Apple Watch</a></td>
                          <td><a href="#!">#21345</a></td>
                          <td>1</td>
                          <td class="  text-dark">$968.09</td>
                          <td>27-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-2.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Apple Watch Dark</a></td>
                          <td><a href="#!">#21344</a></td>
                          <td>1</td>
                          <td class=" text-dark">$868.09</td>
                          <td>26-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-3.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Apple Headphone</a></td>
                          <td><a href="#!">#21343</a></td>
                          <td>1</td>
                          <td class=" text-dark">$1268.09</td>
                          <td>25-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-4.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Apple Watch Dark</a></td>
                          <td><a href="#!">#21342</a></td>
                          <td>1</td>
                          <td class=" text-dark">$768.09</td>
                          <td>25-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-5.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">T-shirt Blue</a></td>
                          <td><a href="#!">#21341</a></td>
                          <td>1</td>
                          <td class=" text-dark">$68.09</td>
                          <td>24-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-6.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Apple Watch Dark</a></td>
                          <td><a href="#!">#21340</a></td>
                          <td>1</td>
                          <td class=" text-dark">$678.09</td>
                          <td>24-08-2023</td>
                        </tr>
                        <tr>
                          <td><a href="#!"><img src="../assets/images/ecommerce/product-7.jpg" alt="Image"
                                class="img-4by3-xs rounded"></a></td>
                          <td><a href="#!" class="text-inherit">Headphone</a></td>
                          <td><a href="#!">#21339</a></td>
                          <td>1</td>
                          <td class=" text-dark">$568.09</td>
                          <td>22-08-2023</td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table class="table text-nowrap mb-0 table-centered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <span class="avatar avatar-xs me-1">
                                <span class="avatar-initials rounded-circle fs-6 bg-primary-soft">OT</span>
                              </span>
                        ...
                        <tr>
                          ...
                          <td><a href="#!" class="text-inherit">
                              <span class="avatar avatar-xs me-1">
                                <span class="avatar-initials rounded-circle fs-6 bg-danger-soft text-danger">RJ</span>
                              </span>
                    ...
                    <table class="table text-nowrap mb-0 table-centered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-1.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">Brilliant Boutique</a></h5>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-2.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">Cartmax</a></h5>
                          ...
                          <td>89% <span class="ms-2"><i class="text-success icon-xs"
                                data-feather="trending-up"></i></span></td>
                        </tr>
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-3.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">DollarSmart</a></h5>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-4.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">Megaplex</a></h5>
                          ...
                          <td>63% <span class="ms-2"><i class="text-success icon-xs"
                                data-feather="trending-up"></i></span></td>
                        </tr>
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-5.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">Shopperia</a></h5>
                          ...
                          <td>55% <span class="ms-2"><i class="text-success icon-xs"
                                data-feather="trending-up"></i></span></td>
                        </tr>
                        <tr>
                          <td>
                            <div class=" d-flex">
                              <a href="#!"> <img src="https://dashui.codescandy.com/dashuipro/assets/images/svg/brand-logo-6.svg" alt="Image"></a>
                              <div class="ms-3 lh-1">
                                <h5 class="mb-0"><a href="#!" class="text-inherit">Freshcommerce</a></h5>
                          ...
                          <td class="  text-dark">$3204</td>
                          <td>67% <span class="ms-2"><i class="text-success icon-xs"
                                data-feather="trending-up"></i></span></td>
                        </tr>
...
<script src="<?php echo base_url(); ?>assets/libs/jsvectormap/dist/js/jsvectormap.min.js"></script>
<script src="<?php echo base_url(); ?>assets/libs/jsvectormap/dist/maps/world.js"></script>
...
<!-- Mirrored from dashui.codescandy.com/dashuipro/horizontal/dashboard-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2025 03:29:29 GMT -->
</html>